 ...
 */
class Careerpress_Dropdown_Taxonomies_Control extends WP_Customize_Control {
    ...
    <label>
      ...
      <?php endif; ?>
       <select <?php $this->link(); ?>>
			<?php
			printf( '<option value="%s" %s>%s</option>', '', selected( $this->value(), '', false ), esc_html__('--None--', 'careerpress') );
			?>
 ...
 * @see WP_Customize_Control
 */
class Careerpress_Dropdown_Category_Control extends WP_Customize_Control {
...
class Careerpress_Note_Control extends WP_Customize_Control {
...
class Careerpress_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Careerpress_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="careerpress-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class Careerpress_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Careerpress_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="careerpress-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'careerpress' ); ?>" class="careerpress-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
...
Class Careerpress_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @since  1.0.0
 */
class Careerpress_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
